...
$$E_P \sim E_0 \frac{e^{ikR}}{R} 2\pi \frac{R}{R+z} \sum_{m=1}^{N} \frac{\lambda K_m}{\pi i} (-1)^m e^{ikz} = \frac{2 E_0 \lambda}{i} \frac{e^{ik(R+z)}}{R+z} \sum_{m=1}^{N} K_m (-1)^m = const \cdot E_0 (K_1 - K_2 + K_3 - K_4 + \dots)$$
