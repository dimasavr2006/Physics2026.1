...
\begin{align*}
	\hat{M} &= \begin{pmatrix} 1 & 0 \\ -\Phi_2 & 1 \end{pmatrix} \begin{pmatrix} 1 & 0 \\ -\Phi_1 & 1 \end{pmatrix} = \\
	&= \begin{pmatrix} 1 & 0 \\ -(\Phi_1+\Phi_2) & 1 \end{pmatrix}
\end{align*}
...
\begin{align*}
	\hat{M}_{\text{полн}} &= \hat{T}_b \cdot \hat{M}_{\text{линзы}} \cdot \hat{T}_a = \begin{pmatrix} 1 & b/n_2 \\ 0 & 1 \end{pmatrix} \begin{pmatrix} 1 & 0 \\ -\Phi & 1 \end{pmatrix} \begin{pmatrix} 1 & a/n_1 \\ 0 & 1 \end{pmatrix} = \\
	&= \begin{pmatrix} 1 - \frac{b}{n_2}\Phi & \frac{a}{n_1} + \frac{b}{n_2} - \frac{ab}{n_1 n_2}\Phi \\ -\Phi & 1 - \frac{a}{n_1}\Phi \end{pmatrix}
\end{align*}
...
\subsection{\texorpdfstring{Случай 1: Параллельная поляризация ($\vb{E}_\parallel$)}{Случай 1: Параллельная поляризация (E parallel)}}
...
\subsection{\texorpdfstring{Случай 2: Перпендикулярная поляризация ($\vb{E}_\perp$)}{Случай 2: Перпендикулярная поляризация (E perpendicular)}}
...
\begin{align*}
	r_\parallel &= \frac{\frac{n_1}{n_2}\cos\theta_2 - \cos\theta_1}{\frac{n_1}{n_2}\cos\theta_2 + \cos\theta_1} = \frac{\frac{\sin\theta_2}{\sin\theta_1}\cos\theta_2 - \cos\theta_1}{\frac{\sin\theta_2}{\sin\theta_1}\cos\theta_2 + \cos\theta_1} = \frac{\sin 2\theta_2 - \sin 2\theta_1}{\sin 2\theta_2 + \sin 2\theta_1} = \\
	&= \frac{\cos(\theta_1+\theta_2)\sin(\theta_2-\theta_1)}{\cos(\theta_2-\theta_1)\sin(\theta_1+\theta_2)} = \frac{\tg(\theta_2 - \theta_1)}{\tg(\theta_1 + \theta_2)}
\end{align*}
